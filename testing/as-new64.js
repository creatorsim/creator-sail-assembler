...
function run(args) {
  ...
  function doRun() {
    ...
    ofile = FS.readFile('./my_code_v2.o');
...
function preprocess_run(file_p, content_p) {
  asmfile = file_p;
  asmcontent = content_p;
  run(["-march=rv64g", "-mabi=lp64d", "-o", "my_code_v2.o", "integer_code.s"]);
  return ofile;
